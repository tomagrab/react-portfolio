...
export default function Navbar() {
  return (
    <aside className="sidebar absolute bottom-0 left-0 right-0 flex h-16 w-full items-center justify-around overflow-hidden bg-mint-cream md:static md:h-screen md:w-20 md:flex-col md:justify-normal md:gap-4 md:shadow-xl">
